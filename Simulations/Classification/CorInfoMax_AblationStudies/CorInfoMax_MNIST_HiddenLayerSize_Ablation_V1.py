...
pickle_name_for_results = "simulation_results_CorInfoMax_MNIST_HiddenLayerSize_Ablation.pkl"
...
neural_lr_rule_list = ["constant", "divide_by_slow_loop_index"]
...
hidden_layer_size_list = [256, 512, 1024, 2048]
n_epochs = 50
seed_list = [10*j for j in range(2)]

setting_number = 0
for lr_start, lr_decay_multiplier, neural_lr_start, neural_lr_rule, neural_dynamic_iterations_free, hopfield_g, use_three_phase, hidden_layer_size in product(lr_start_list, lr_decay_multiplier_list, neural_lr_start_list, neural_lr_rule_list, neural_dynamic_iterations_free_list, hopfield_g_list, use_three_phase_list, hidden_layer_size_list):
    setting_number += 1
    
    architecture = [784, hidden_layer_size, hidden_layer_size, 10]
