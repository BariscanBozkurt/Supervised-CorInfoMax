...
pickle_name_for_results = "simulation_results_CorInfoMax_CIFAR100_4Layers_V1.pkl"
...
lr_start_list = [{'ff' : np.array([0.21, 0.17, 0.12, 0.07]), 'fb': np.array([np.nan, 0.11, 0.06, 0.04])},
                 {'ff' : np.array([0.25, 0.19, 0.15, 0.09]), 'fb': np.array([np.nan, 0.14, 0.09, 0.06])},
                 {'ff' : np.array([0.20, 0.15, 0.11, 0.05]), 'fb': np.array([np.nan, 0.12, 0.07, 0.045])}]

lr_decay_multiplier_list = [0.99]
neural_lr_start_list = [0.05, 0.07]
neural_lr_stop = 0.001
neural_lr_rule_list = ["constant"]
neural_lr_decay_multiplier = 0.01
neural_dynamic_iterations_nudged = 25
neural_dynamic_iterations_free_list = [150, 100]
hopfield_g_list = [0.1]
