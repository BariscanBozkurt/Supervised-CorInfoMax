...
pickle_name_for_results = "simulation_results_CSM_MNIST_V2.pkl"
...
alphas_W_list = [[0.4, 0.275], [0.3, 0.175]]
alphas_M_list = [[-0.01]]
T1_list = [20]
T2_list = [4]
neural_lr_list = [0.5]
...
setting_number = 0
for alphas_W, alphas_M, T1, T2, neural_lr in product(alphas_W_list, alphas_M_list, T1_list, T2_list, neural_lr_list):
    setting_number += 1
