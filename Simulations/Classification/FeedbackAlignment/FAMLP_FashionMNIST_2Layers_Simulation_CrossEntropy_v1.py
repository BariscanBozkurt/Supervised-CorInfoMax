...
pickle_name_for_results = "simulation_results_FeedbackAlignment_FashionMNIST_2Layers_CrossEntropy_V1.pkl"
...
lr_list = [0.0005, 1e-3]
lr_decay_gamma_list = [0.95]
lr_decay_scheduler_step_list = [25]
