...
pickle_name_for_results = "simulation_results_PCNudge_CIFAR10.pkl" # THIS LINE NEED TO BE ADJUSTED ACCORDING TO EXPERIMENT
...
activation = F.relu
architecture = [int(32*32*3), 256, 64, 10]
...
random_sign_use_list = [True, False]
...
for random_sign in random_sign_use_list:
    ...
    for seed_ in seed_list:
        ...
        model = SupervisedPredictiveCodingNudgedV2_wAutoGrad(architecture, activation, use_stepLR = True, 
                                                             ...
                                                             optim_lr = weight_lr, stepLR_step_size = 10*3000,
                                                             stepLR_gamma = 0.75)
