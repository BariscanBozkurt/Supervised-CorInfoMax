...
pickle_name_for_results = "simulation_results_CorInfoMaxSparse_FashionMNIST_V8.pkl"
...
lr_start_list = [{'ff' : np.array([0.35, 0.23]), 'fb': np.array([np.nan, 0.05])}]
