...
pickle_name_for_results = "simulation_results_CorInfoMax_MNIST_V2.pkl"
...
lr_start_list = [{'ff' : np.array([0.25, 0.12]), 'fb': np.array([0.15, 0.1])}, {'ff' : np.array([0.2, 0.1]), 'fb': np.array([0.1, 0.05])}]
