...
pickle_name_for_results = "simulation_results_CorInfoMax_CIFAR100_V1.pkl"
...
lr_start_list = [{'ff' : np.array([0.15, 0.12, 0.07]), 'fb': np.array([np.nan, 0.05, 0.03])}, {'ff' : np.array([0.16, 0.08, 0.05]), 'fb': np.array([np.nan, 0.04, 0.02])}]
lr_decay_multiplier_list = [1.0]
neural_lr_start_list = [0.04]
